    ...
    return (
        <section className="hero-gradient text-white">
            <div className="container mx-auto px-6 text-center py-20 md:py-28">
                ...
                <p className="text-lg md:text-xl text-blue-200 max-w-3xl mx-auto mb-8">Gestionamos tus Teléfonos y correos electrónicos en la lista “No Molestar” del SERNAC y bloqueamos la publicidad de las principales empresas de retail, telecomunicaciones y banca.</p>
