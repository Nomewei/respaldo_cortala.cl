    ...
    return (
        <section className="hero-gradient text-white">
            <div className="container mx-auto px-6 text-center py-20 md:py-28">
                ...
                <p className="text-lg md:text-xl text-blue-200 max-w-3xl mx-auto mb-8">Gestionamos el ingreso de tus teléfonos y correos en la lista "No Molestar" del SERNAC. Bloqueamos a las principales empresas de Retail, Telecoms, Bancos, entre otras.</p>
