        ...
        <section className="hero-gradient text-white">
            <div className="container mx-auto px-6 text-center py-20 md:py-28">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight mb-4">
                    Libérate del SPAM en sólo 3 pasos
                </h1>
                <p className="text-lg md:text-xl text-blue-200 max-w-3xl mx-auto mb-8">
                    Gestionamos el ingreso de tus teléfonos y correos en la lista "No Molestar" del SERNAC. Rápido, fácil y en un Pago Único.
                </p>
                <button onClick={onStart} className="bg-white text-blue-700 font-bold py-3 px-8 rounded-full text-lg hover:bg-blue-100 transition transform hover:scale-105 inline-block">
                    Comenzar Ahora
                </button>
                <div className="mt-12">
